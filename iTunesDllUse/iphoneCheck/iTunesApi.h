...
typedef int(*func_AMDevicePair)(struct am_device *device);
typedef int		(*func_AMDeviceUnpair)(struct am_device *device);
...
typedef int			(*func_AMDeviceLookupApplications)(void *device, void* apptype, void** result);
...
typedef	int			(*func_AMDeviceGetInterfaceType)(void* handle);
...
public:
	...
	static func_AMDeviceUnpair					AMDeviceUnpair;
	...
	static func_AMDevicePair					AMDevicePair;
